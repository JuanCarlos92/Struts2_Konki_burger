...
<head>
    <meta charset="UTF-8">
    <title>Header Funcional</title>
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container-fluid bg-white py-2 px-3">
    <div class="d-flex justify-content-between align-items-center">
        <!-- Sección izquierda -->
        <div class="d-flex align-items-center">
            <span>Administrador / </span>
            <span class="ms-2"><s:property value="#request.paginaActual"/></span>
        </div>
...
<%--            </svg>--%>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUserButton">
                    <li><a class="dropdown-item" href="Login?BotonPulsadoCerrarSesion=true">Cerrar sesión</a></li>
                </ul>
            </div>
        </div>
    </div>
